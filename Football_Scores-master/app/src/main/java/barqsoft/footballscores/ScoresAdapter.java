 ...
 * Expose information from Scores database to the list view
 */
public class ScoresAdapter extends CursorAdapter
{
    ...
    public void bindView(View view, final Context context, Cursor cursor){
        ...
        if(mHolder.match_id == detail_match_id){
            ...
            share_button.setContentDescription( context.getString(R.string.share_text)  + " " + home + " " +
                    context.getString(R.string.vs) + " " + away);
